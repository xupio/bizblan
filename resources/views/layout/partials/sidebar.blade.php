<nav class="sidebar">
  ...
  <div class="sidebar-body">
    <ul class="nav" id="sidebarNav">
      ...
      <li class="nav-item {{ active_class(['/', 'business-plan']) }}">
        <a href="{{ url('/business-plan') }}" class="nav-link">
          <i class="link-icon" data-lucide="briefcase-business"></i>
          <span class="link-title">Business Plan</span>
        </a>
      </li>
      <li class="nav-item {{ active_class(['company-structure']) }}">
        <a href="{{ url('/company-structure') }}" class="nav-link">
          <i class="link-icon" data-lucide="building-2"></i>
          <span class="link-title">Company Structure</span>
        </a>
      </li>
      <li class="nav-item {{ active_class(['market-study']) }}">
        <a href="{{ url('/market-study') }}" class="nav-link">
          <i class="link-icon" data-lucide="chart-column"></i>
          <span class="link-title">Market Study</span>
        </a>
      </li>
      <li class="nav-item {{ active_class(['financial-plan']) }}">
        <a href="{{ url('/financial-plan') }}" class="nav-link">
          <i class="link-icon" data-lucide="badge-dollar-sign"></i>
          <span class="link-title">Financial Plan</span>
        </a>
      </li>
      <li class="nav-item {{ active_class(['product-workspace']) }}">
        <a href="{{ url('/product-workspace') }}" class="nav-link">
          <i class="link-icon" data-lucide="package-search"></i>
          <span class="link-title">Product Workspace</span>
        </a>
      </li>
      <li class="nav-item {{ active_class(['dashboard-demo']) }}">
        <a href="{{ url('/dashboard-demo') }}" class="nav-link">
          <i class="link-icon" data-lucide="layout-dashboard"></i>
          <span class="link-title">Template Demo</span>
        </a>
      </li>
