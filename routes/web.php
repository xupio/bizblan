...
Route::get('/market-study', function () {
    return view('market-study');
});

Route::get('/financial-plan', function () {
    return view('financial-plan');
});

Route::get('/product-workspace', function () {
    return view('product-workspace');
});
...
Route::group(['prefix' => 'auth'], function(){
    ...
    Route::get('forgot-password', function () { return view('pages.auth.forgot-password'); });
});
